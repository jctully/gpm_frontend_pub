...
import CreateAdmin from "../Admin/create.admin.component";
import StudentsList from "../Admin/list.students.component";
import AdminsList from "../Admin/list.admins.component";
...
import EditAdmin from "../Admin/edit.admin.component";
      ...
      <Router>
        <div>
          ...
          <Link to="/admin/create/admin">
            <button className="button-admin">Create Admin</button>
          </Link>

          <Link to="/admin/view/admin">
            <button className="button-admin">View Admin</button>
          </Link>
