...
export default class EditStudent extends Component {
  constructor(props) {
    ...
    this.onChangePlanOfStudyAmendmentLink = this.onChangePlanOfStudyAmendmentLink.bind(
      this
    );
    this.onChangeResearchForm692Link = this.onChangeResearchForm692Link.bind(
      this
    );
  ...
  componentDidMount() {
    axios
      .get(
        'https://gradprogmantest.herokuapp.com/students/' +
      ...
      .then(response => {
        this.setState({
          ...
          plan_of_study_amendments_link:
            response.data.plan_of_study_amendments_link,
  ...
  onSubmit(e) {
    ...
    axios
      .post(
        'https://gradprogmantest.herokuapp.com/students/update/' +
          this.props.match.params.id,
        obj
      )
